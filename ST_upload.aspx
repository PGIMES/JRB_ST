<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ST_upload.aspx.cs" Inherits="ST_upload" %>
    ...
    <div class="col-md-12  ">
        <div class="row row-container">
            <table style="margin:10px 10px;">
                <tr>
                    <td>
                        <dx:aspxuploadcontrol ID="uploadcontrol" runat="server" Width="530px" BrowseButton-Text="浏览"  Visible="true" ClientInstanceName="UploadControl" 
